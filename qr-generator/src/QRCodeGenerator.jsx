          ...
          <div className="p-8">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                {activeTab === 'url' && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 text-gray-100 placeholder-gray-400 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200"
                    />
                ...
                {activeTab === 'text' && (
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 text-gray-100 placeholder-gray-400 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 resize-none"
                    />
                  </div>
                )}
                ...
                <button
                  onClick={resetForm}
                  className="w-full px-6 py-3 bg-gray-700 text-gray-300 rounded-xl hover:bg-gray-600 transition-all duration-200 font-medium border border-gray-600"
                >
                  {t('clearAllFields')}
                </button>
              </div>
              ...
              <div className="flex flex-col items-center space-y-6">
                <h2 className="text-2xl font-semibold text-gray-100">{t('generatedQrCode')}</h2>
                
                <div className="bg-gray-700 rounded-2xl p-8 w-full max-w-sm border border-gray-600">
                  {qrData ? (
                ...
                {qrData && (
                  <div className="flex gap-4 w-full max-w-sm">
                    ...
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-gray-700 text-gray-300 rounded-xl hover:bg-gray-600 transition-all duration-200 font-medium border border-gray-600"
                    >
                      {copied ? (
                        <>
                ...
                {qrData && (
                  <div className="w-full max-w-sm">
                    <h3 className="text-sm font-medium text-gray-300 mb-2">{t('qrCodeData')}</h3>
                    <div className="bg-gray-700 rounded-lg p-3 text-xs text-gray-300 max-h-32 overflow-y-auto border border-gray-600">
